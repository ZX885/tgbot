...
def _send_local_file():
    ...
    with open("zx.jpg", "rb") as f:
        ...
        """
        bot.reply_photo(f, caption="Hello!Nice to meet you! This is Telegram Bot of ZX_Company commands:/start   - Start the bot/help    - Help /buttons_below    - Get Optional buttons/buttons_attached - Get Attached buttons")


def _send_mp3(update: Update, context: CallbackContext):
    with open("1592900853.mp3", "rb") as f:
